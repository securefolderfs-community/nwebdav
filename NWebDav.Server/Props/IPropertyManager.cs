...
namespace NWebDav.Server.Props
{
    ...
    public interface IPropertyManager
    {
        ...
        /// </returns>
        Task<object> GetPropertyAsync(HttpListenerContext context, IDavStorable item, XName propertyName, bool skipExpensive = false);
        ...
        /// </returns>
        Task<HttpStatusCode> SetPropertyAsync(HttpListenerContext context, IDavStorable item, XName propertyName, object value);
    }
}
