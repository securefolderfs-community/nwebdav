...
namespace NWebDav.Server.Stores
{
    ...
    public sealed class RootDiskStore : IStore
    {
        ...
        public Task<IStoreItem> GetItemAsync(Uri uri, HttpListenerContext context)
        {
        ...
        public Task<IStoreCollection> GetCollectionAsync(Uri uri, HttpListenerContext context)
        {
            if (!uri.LocalPath.StartsWith($"/{_remoteRootDirectory}"))
